 ...
 */
@WebServlet("/ProfListController")
public class ProfListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProfListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//request.getRequestDispatcher("/WEB-INF/lists/ProfessorList.jsp").forward(request, response);
	}
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
	 ...
	 String page="/WEB-INF/lists/ProfessorList.jsp";
	  
	 List<Professor> dataList = new ArrayList<Professor>(); 
